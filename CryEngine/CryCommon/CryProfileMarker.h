...
namespace CryProfile
{
	...
	inline void PushProfilingMarker( const char *pName ) { CryProfile::detail::PushProfilingMarker(pName); }
	...
	{
	public:
		inline CScopedProfileMarker( const char *pName ) { CryProfile::detail::PushProfilingMarker(pName); }
		inline ~CScopedProfileMarker() { CryProfile::detail::PopProfilingMarker(); }
	};
