...
CRY_MEM_USAGE_API void CryModuleGetMemoryInfo( CryModuleMemoryInfo *pMemInfo );
					...
					CRYMM_INLINE void * operator new(_CSTD size_t size) throw (std::bad_alloc)
					{
					...
					CRYMM_INLINE void* operator new (_CSTD size_t size, const std::nothrow_t &nothrow) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						void* ret = CryModuleMalloc(size);
						MEMREPLAY_SCOPE_ALLOC(ret, size, 0);
					...
					CRYMM_INLINE void *operator new(_CSTD size_t size, _CSTD size_t cAlignment) throw (std::bad_alloc)
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
					...
					CRYMM_INLINE void *operator new(_CSTD size_t size, _CSTD size_t cAlignment, const std::nothrow_t&) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						void* ret = CryModuleMemalign(size, cAlignment);
						MEMREPLAY_SCOPE_ALLOC(ret, size, cAlignment);
					...
					CRYMM_INLINE void operator delete(void *p) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						CryModuleFree(p);
						MEMREPLAY_SCOPE_FREE(p);
					...
					CRYMM_INLINE void operator delete(void *p, const std::nothrow_t&) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						CryModuleFree(p);
						MEMREPLAY_SCOPE_FREE(p);
					...
					CRYMM_INLINE void * __cdecl operator new   (size_t size) CRYMM_THROW_BAD_ALLOC
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						void* ret = CryModuleMalloc(size);
						MEMREPLAY_SCOPE_ALLOC(ret, size, 0);
					...
					CRYMM_INLINE void * __cdecl operator new   (size_t size, const std::nothrow_t& x) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						void* ret = CryModuleMalloc(size);
						MEMREPLAY_SCOPE_ALLOC(ret, size, 0);
					...
					CRYMM_INLINE void * __cdecl operator new[] (size_t size, const std::nothrow_t &nothrow) throw()
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNewArray);
						void* ret = CryModuleMalloc(size);
						MEMREPLAY_SCOPE_ALLOC(ret, size, 0);
					...
					CRYMM_INLINE void __cdecl operator delete  (void *p) CRYMM_THROW
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						CryModuleFree(p);
						MEMREPLAY_SCOPE_FREE(p);
					...
					CRYMM_INLINE void __cdecl operator delete  (void *p, const std::nothrow_t&) CRYMM_THROW
					{
						MEMREPLAY_SCOPE(EMemReplayAllocClass::C_UserPointer, EMemReplayUserPointerClass::C_CrtNew);
						CryModuleFree(p);
						MEMREPLAY_SCOPE_FREE(p);
