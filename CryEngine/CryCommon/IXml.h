...
public:
   ...
   // Summary:
	...
	virtual void setAttr( const char* key,const Vec2_f64& value ) = 0;
	...
	virtual void setAttr( const char* key,const Vec3_f64& value ) = 0;
	...
	virtual bool getAttr( const char *key,Vec2_f64& value ) const = 0;
	...
	virtual bool getAttr( const char *key,Vec3_f64& value ) const = 0;
