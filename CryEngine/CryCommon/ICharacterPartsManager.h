...
//-------------------------------------------------------------------------
struct IPartMorph // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
	virtual ~IPartMorph(){}
  // Morph switch
...
//-------------------------------------------------------------------------
struct IPartMaterial // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
...
//-------------------------------------------------------------------------
struct IPartSocket // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
	virtual ~IPartSocket(){}
  // Socket name
  virtual const char* GetName() const = 0;
...
//-------------------------------------------------------------------------
struct ICharacterPartTemplate // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
...
//-------------------------------------------------------------------------
struct IPartModel // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
	virtual ~IPartModel(){}
  // Model filename (.CHR)
  virtual const char* GetFilename() const = 0;
...
//-------------------------------------------------------------------------
struct ICharacterPart // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
...
//-------------------------------------------------------------------------
struct ICharacterPartsManager // make unique again for PS3 if feature is used (see INCLUDE_CHARACTERPARTSMANAGER in CryAction)
{
