...
// for Crysis3 we use the non-thread safe ref counts for boost shared/weak ptr
// since we don't know the usage in other projects, enable this on a per project basis
