...
public:
	...
	virtual void GetFrameStats(TJobFrameStatsContainer& rJobStats) const = 0;
	virtual void GetFrameStats(JobManager::CWorkerFrameStats& rStats, TJobFrameStatsContainer& rJobStats) const = 0;
