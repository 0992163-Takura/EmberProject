...
public:
	...
	VIRTUAL ICharacterPartsManager* GetICharacterPartsManager();
  ...
  virtual CCompoundCharacterCache* GetCompoundCharacterCacheManager()
  {
    return m_pCompoundCharacterCache;
  }
...
private:
  ...
  static void TestPlayerBoundsCmd(IConsoleCmdArgs* args);
	...
	CCharacterPartsManager* m_pCharacterPartsManager;
	CCompoundCharacterCache* m_pCompoundCharacterCache;
