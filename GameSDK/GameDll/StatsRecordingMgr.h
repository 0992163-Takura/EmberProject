...
public:
    ...
    TSubmitPermissions												GetSubmitPermissions()
    {
        return m_submitPermissions;
    }
    ...
    IStatsTracker															*GetSessionTracker()
    {
        return m_sessionTracker;
    }
    IStatsTracker															*GetRoundTracker()
    {
        return m_roundTracker;
    }
