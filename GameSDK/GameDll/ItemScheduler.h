...
public:
    ...
    ILINE void TimerAction(uint32 time, ISchedulerAction *action, bool persistent=false)
    {
        TimerAction((float)time*0.001f, action, persistent);
    }
    ILINE void TimerAction(int time, ISchedulerAction *action, bool persistent=false)
    {
        TimerAction((float)time*0.001f, action, persistent);
    }
