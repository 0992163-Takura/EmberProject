...
public:
    ...
    ILINE uint16 GetFlags()
    {
        return m_netSyncFlags;
    }
    ILINE void SetFlags(uint16 f)
    {
        m_netSyncFlags = f;
    }
...
public:
    ...
    {
        m_netActionSync.ChangeAuthority();
    }
    ...
    ILINE void SetYawResponseScalar (float val)
    {
        m_yawResponseScalar = val;
    }
