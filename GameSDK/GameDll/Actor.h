...
#define MAX_WEAPON_ATTACHMENTS 31
    ...
    {
        return m_bAwaitingServerUseResponse;
    };
...
public:
    ...
    //------------------------------------------------------------------------
    ILINE float GetAirControl() const
    {
        return m_airControl;
    };
    ILINE float GetAirResistance() const
    {
        return m_airResistance;
    };
    ILINE float GetInertia() const
    {
        return m_inertia;
    }
    ILINE float GetInertiaAccel() const
    {
        return m_inertiaAccel;
    }
    ILINE float GetTimeImpulseRecover() const
    {
    ...
    {
        return m_health.GetHealthAsRoundedPercentage();
    }
    ...
    CActorWeakPtr GetWeakPtr() const
    {
        return m_pThis;
    }
    CActorTelemetry *GetTelemetry()
    {
        return &m_telemetry;
    }
    ...
    ILINE static const SActorAnimationEvents& GetAnimationEventsTable()
    {
    ...
    CDamageEffectController& GetDamageEffectController()
    {
        return m_damageEffectController;
    }
    uint8 GetActiveDamageEffects() const
    {
        return m_damageEffectController.GetActiveEffects();
    }
    uint8 GetDamageEffectsResetSwitch() const
    {
        return m_damageEffectController.GetEffectResetSwitch();
    }
    uint8 GetDamageEffectsKilled() const
    {
        return m_damageEffectController.GetEffectsKilled();
    }
    void SetActiveDamageEffects(uint8 active)
    {
        m_damageEffectController.SetActiveEffects(active);
    }
    void SetDamageEffectsResetSwitch(uint8 reset)
    {
        m_damageEffectController.SetEffectResetSwitch(reset);
    }
    void SetDamageEffectsKilled(uint8 killed)
    {
        m_damageEffectController.SetEffectsKilled(killed);
    }
    CActorImpulseHandlerPtr GetImpulseHander()
    {
        return m_pImpulseHandler;
    }
    ...
    ILINE TBodyDamageProfileId GetCurrentBodyDamageProfileId() const
    {
        return (m_OverrideBodyDamageProfileId != INVALID_BODYDAMAGEPROFILEID) ? m_OverrideBodyDamageProfileId : m_DefaultBodyDamageProfileId;
    }
    void ReloadBodyDestruction();

    const CBodyDestrutibilityInstance& GetBodyDestructibilityInstance() const
    {
        return m_bodyDestructionInstance;
    }
    ...
    ILINE bool AllowSwitchingItems()
    {
        return m_enableSwitchingItems;
    }
    ...
    {
        return m_enableIronSights;
    }
    bool CanPickupItems() const
    {
        return m_enablePickupItems;
    }
    ...
    ILINE const SActorPhysics& GetActorPhysics() const
    {
        return m_actorPhysics;
    }
    ...
    {
        m_shouldPlayHitReactions = false;
    }
    bool ShouldPlayHitReactions() const
    {
        return m_shouldPlayHitReactions;
    }

    EntityId GetPendingDropEntityId() const
    {
        return m_pendingDropEntityId;
    }
...
protected:
    ...
    virtual bool ShouldRegisterAsAutoAimTarget()
    {
        return true;
    }
