...
XmlNodeRef CEnvironmentalWeaponEvent::GetXML(IGameStatistics* pGS)
{
    ...
    switch( m_action )
        ...
        case eEVE_Drop:
            actionName = "drop";
            break;
        case eEVE_MeleeAttack:
            actionName = "meleeAttack";
            break;
        case eEVE_MeleeKill:
            actionName = "meleeKill";
            break;
        case eEVE_ThrowAttack:
            actionName = "throwAttack";
            break;
        case eEVE_ThrowKill:
            actionName = "throwKill";
            break;
        }
...
XmlNodeRef CSpearStateEvent::GetXML(IGameStatistics* pGS)
{
    ...
    switch( m_state )
        ...
        case eSSE_neutral:
            stateName = "neutral";
            break;
        case eSSE_capturing_from_neutral:
            stateName = "capturing_from_neutral";
            break;
        case eSSE_captured:
            stateName = "captured";
            break;
        case eSSE_capturing_from_capture:
            stateName = "capturing_from_capture";
            break;
        case eSSE_contested:
            stateName = "contested";
            break;
        case eSSE_failed_capture:
            stateName = "failed_capture";
            break;
        }
