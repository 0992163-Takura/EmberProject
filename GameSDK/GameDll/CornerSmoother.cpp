...
void SetLimitsFromMovementAbility(const struct AgentMovementAbility& movementAbility, const EStance stance, const float pseudoSpeed, struct SMovementLimits& output)
{
    ...
    switch (stance)
        {
        case STANCE_STEALTH:
            agentStance = AgentMovementSpeeds::AMS_STEALTH;
            break;
        case STANCE_CROUCH:
            agentStance = AgentMovementSpeeds::AMS_CROUCH;
            break;
        case STANCE_PRONE:
            agentStance = AgentMovementSpeeds::AMS_PRONE;
            break;
        case STANCE_SWIM:
            agentStance = AgentMovementSpeeds::AMS_SWIM;
            break;
        case STANCE_RELAXED:
            agentStance = AgentMovementSpeeds::AMS_RELAXED;
            break;
        case STANCE_ALERTED:
            agentStance =  AgentMovementSpeeds::AMS_ALERTED;
            break;
        case STANCE_LOW_COVER:
            agentStance = AgentMovementSpeeds::AMS_LOW_COVER;
            break;
        case STANCE_HIGH_COVER:
            agentStance = AgentMovementSpeeds::AMS_HIGH_COVER;
            break;
        default:
            agentStance = AgentMovementSpeeds::AMS_COMBAT;
            break;
        };
