...
#include "GameActions.actions"
    ...
    ILINE IActionFilter*	FilterTutorialNoMove() const
    {
        return m_pFilterTutorialNoMove;
    }
    ILINE IActionFilter*	FilterNoWeaponCustomization() const
    {
        return m_pFilterNoWeaponCustomization;
    }
    ILINE IActionFilter*	FilterNoFireModeSwitch() const
    {
        return m_pFilterNoFireModeSwitch;
    }
    ILINE IActionFilter*	FilterWarningPopup() const
    {
        return m_pFilterWarningPopup;
    }
    ILINE IActionFilter*	FilterMindControlMenu() const
    {
        return m_pFilterMindControlMenu;
    }
    ILINE IActionFilter*	FilterFreezeTime() const
    {
        return m_pFilterFreezeTime;
    }
    ILINE IActionFilter*	FilterHostMigration() const
    {
        return m_pFilterHostMigration;
    }
    ILINE IActionFilter*	FilterMPPreGameFreeze() const
    {
        return m_pFilterMPPreGameFreeze;
    }
    ...
    ILINE IActionFilter*	FilterMPChat() const
    {
        return m_pFilterMPChat;
    }
    ...
    ILINE IActionFilter*  FilterCutsceneTrain() const
    {
        return m_pFilterCutsceneTrain;
    }
    ILINE IActionFilter*	FilterCutscenePlayerMoving() const
    {
        return m_pFilterCutscenePlayerMoving;
    }
    ...
    ILINE IActionFilter*	FilterTweakMenu() const
    {
        return m_pFilterTweakMenu;
    }
    ILINE IActionFilter*	FilterIngameMenu() const
    {
        return m_pFilterIngameMenu;
    }
    ILINE IActionFilter*	FilterScoreboard() const
    {
        return m_pFilterScoreboard;
    }
    ILINE IActionFilter*	FilterStrikePointer() const
    {
        return m_pFilterStrikePointer;
    }
    ILINE IActionFilter*	FilterUseKeyOnly() const
    {
        return m_pFilterUseKeyOnly;
    }
    ILINE IActionFilter*  FilterInfictionMenu()const
    {
        return m_pFilterInfictionMenu;
    }
    ILINE IActionFilter*  FilterMPWeaponCustomizationMenu()const
    {
        return m_pFilterMPWeaponCustomizationMenu;
    }
    ILINE IActionFilter*  FilterLedgeGrab()const
    {
        return m_pFilterLedgeGrab;
    }
    ILINE IActionFilter*  FilterVault()const
    {
        return m_pFilterVault;
    }
    ILINE IActionFilter*  FilterItemPickup()const
    {
        return m_pFilterItemPickup;
    }
    ILINE IActionFilter*  FilterNotYetSpawned()const
    {
        return m_pFilterNotYetSpawned;
    }
    ILINE IActionFilter*  FilterButtonMashingSequence() const
    {
        return m_pFilterButtonMashingSequence;
    }
