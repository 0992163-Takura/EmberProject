...
public:
    ...
    ILINE bool IsStuck() const
    {
        return (m_flags&eSF_IsStuck)!=0;
    }
    ILINE EntityId GetStuckEntityId() const
    {
        return m_parentId;
    }
    ILINE const Vec3& GetNormal() const
    {
        return m_stuckNormal;
    }
    bool IsStuckToPlayer() const;
    bool IsStuckToAI() const;
    ILINE int GetStuckJoint() const
    {
        return m_stuckJoint;
    }
    bool IsValid() const;
