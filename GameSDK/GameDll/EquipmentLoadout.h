...
#define EQUIPMENT_PACKAGE_TYPES(f) \
    ...
    void SetPackageGroup( EEquipmentPackageGroup loadoutSet )
    {
        m_currentPackageGroup = loadoutSet;
    }
    EEquipmentPackageGroup GetPackageGroup() const
    {
        return m_currentPackageGroup;
    }
    ...
    void SetHasPreGameLoadoutSent(bool hasSent)
    {
        m_hasPreGamePackageSent = hasSent;
    }
    bool GetHasPreGameLoadoutSent()
    {
        return m_hasPreGamePackageSent;
    }
    ...
    void AddPackageToBeUnlocked(int index)
    {
        m_unlockPack = index;
    }
    int GetPackageToBeUnlocked() const
    {
        return m_unlockPack;
    }
    ...
    void AddItemToBeUnlocked(int index)
    {
        m_unlockItem = index;
    }
    int GetTokenUnlockItem()
    {
        return m_unlockItem;
    }
    ...
    const char* GetLastSelectedWeaponName() const
    {
        return m_lastSelectedWeaponName.c_str();
    }
    ILINE void InformNoLongerCustomizingWeapon()
    {
        m_currentlyCustomizingWeapon = false;
    }
    ILINE bool IsCustomizingWeapon() const
    {
        return m_currentlyCustomizingWeapon;
    }
    ...
    void SetCurrentUICategory(EEquipmentLoadoutUICategories uiCategory)
    {
        m_curUICategory = uiCategory;
    }
    EEquipmentLoadoutUICategories GetCurrentUICategory() const
    {
        return m_curUICategory;
    }

    void SetUICustomiseAttachments(bool bCustomiseAttachments)
    {
        m_curUICustomiseAttachments = bCustomiseAttachments;
    }
    bool GetUICustomiseAttachments() const
    {
        return m_curUICustomiseAttachments;
    }
...
public:
    ...
    const TEquipmentItems& GetAllItems()
    {
        return m_allItems;
    }
