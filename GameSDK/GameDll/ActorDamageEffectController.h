...
public:
    ...
    uint8 GetActiveEffects() const
    {
        return m_activeEffectsBitfield;
    }
    uint8 GetEffectResetSwitch() const
    {
        return m_effectsResetSwitchBitfield;
    }
    uint8 GetEffectsKilled() const
    {
        return m_effectsKillBitfield;
    }
...
public:
    ...
    virtual void Init(CActor* actor, const IItemParamsNode* params)
    {
        m_ownerActor = actor;
    }
    virtual void Enter() {};
...
public:
    ...
    virtual ~CKVoltEffect()
    {
        SAFE_RELEASE(m_particleEmitter);
        SAFE_RELEASE(m_particleEffect);
        SAFE_RELEASE(m_screenEffect);
    }
