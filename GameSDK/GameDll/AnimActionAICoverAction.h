...
public:
    ...
    ECoverBodyDirection GetTargetCoverBodyDirection() const
    {
        return m_targetCoverBodyDirection;
    }
    bool IsTargetCoverBodyDirectionSet() const
    {
        return m_isTargetCoverBodyDirectionSet;
    }
...
private:
    ...
    typedef SCRCRef< TAG_DEBUG_STRING_LENGTH, TAG_ID_INVALID, COVER_ACTION_STORE_NAME() > TCoverActionName;
