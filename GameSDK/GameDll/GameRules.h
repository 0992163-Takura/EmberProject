...
{
    SProjectileExplosionParams_Impact()
    {
        m_params.m_impact = true;
    }
    SProjectileExplosionParams_Impact(const SProjectileExplosionParams& params) : m_params(params)
    {
        m_params.m_impact = true;
    }
...
#define ERTRList(f)														\
    ...
    ILINE uint32	GetSecurity()
    {
        return m_uSecurity ^ 0xD5379AD1;
    }
    ILINE bool		IsSecurityInitialized()
    {
        return m_bSecurityInitialized;
    }
    ...
    ILINE CBattlechatter* GetBattlechatter() const
    {
        return m_pBattlechatter;
    }
    ILINE CAreaAnnouncer* GetAreaAnnouncer() const
    {
        return m_pAreaAnnouncer;
    }
    ILINE CMiscAnnouncer* GetMiscAnnouncer() const
    {
        return m_pMiscAnnouncer;
    }
    ILINE CVTOLVehicleManager*		GetVTOLVehicleManager() const
    {
        return m_pVTOLVehicleManager;
    };
    ILINE CTeamVisualizationManager*		GetTeamVisualizationManager() const
    {
        return m_pTeamVisualizationManager;
    };
    ILINE CCorpseManager*					GetCorpseManager() const
    {
        return m_pCorpseManager;
    };

    int GetChannelId(EntityId entityId) const;
    ILINE int GetNumChannels() const
    {
        return m_channelIds.size();
    }
    ILINE const std::vector<int>* GetChannelIds() const
    {
        return &m_channelIds;
    }

    void ShowScores(bool show);
    ILINE bool IsLevelLoaded() const
    {
        return m_levelLoaded;
    }

    // Intro
    ILINE void SetIntroSequenceRegistered(const bool bRegister)
    {
        m_bIntroSequenceRegistered = bRegister;
    }
    ILINE bool IsIntroSequenceRegistered() const
    {
        return m_bIntroSequenceRegistered;
    }
    ILINE void SetIntroSequenceCurrentlyPlaying(bool bPlaying)
    {
        m_bIntroCurrentlyPlaying = bPlaying;
    }
    ILINE bool IsIntroSequenceCurrentlyPlaying()
    {
        return m_bIntroCurrentlyPlaying;
    }
    ILINE bool IntroSequenceHasCompletedPlaying()
    {
        return m_bIntroSequenceCompletedPlaying;
    }
    ILINE void SetIntroSequenceHasCompletedPlaying()
    {
        m_bIntroSequenceCompletedPlaying = true;
    }
    ...
    CCinematicInput& GetCinematicInput()
    {
        return m_cinematicInput;
    }
    ...
    {
        return m_bClientKickVoteActive;
    }
    bool CanSendKickVote() const
    {
        return m_bClientKickVoteActive && !m_bClientKickVoteSent;
    }
    bool ClientKickVotedFor() const
    {
        return m_bClientKickVotedFor;
    }
    bool HasVotingCooldownEnded (float &timeLeft) const;

    bool IsTeamGame() const
    {
        return m_bIsTeamGame;
    }
    ...
    struct DevCheatHandlingParams
    {
        ...
        DevCheatHandlingParams(const char * pMessage)
        {
            message = pMessage;
        }
...
public:
    ...
    {
        return s_gameModeNames;
    }
    ILINE EGameMode GetGameMode() const
    {
        return m_gameMode;
    }
...
public:
    IGameRulesTeamsModule*							GetTeamsModule()
    {
        return m_teamsModule;
    }
    IGameRulesStateModule*							GetStateModule()
    {
        return m_stateModule;
    }
    IGameRulesVictoryConditionsModule*	GetVictoryConditionsModule()
    {
        return m_victoryConditionsModule;
    }
    IGameRulesPlayerSetupModule*				GetPlayerSetupModule()
    {
        return m_playerSetupModule;
    }
    IGameRulesScoringModule*						GetScoringModule()
    {
        return m_scoringModule;
    }
    IGameRulesAssistScoringModule*			GetAssistScoringModule()
    {
        return m_assistScoringModule;
    }
    IGameRulesPlayerStatsModule*				GetPlayerStatsModule()
    {
        return m_playerStatsModule;
    }
    ...
    {
        return m_damageHandlingModule;
    }
    IGameRulesActorActionModule*				GetActorActionModule()
    {
        return m_actorActionModule;
    }
    IGameRulesSpectatorModule*					GetSpectatorModule()
    {
        return m_spectatorModule;
    }
    IGameRulesObjectivesModule*					GetObjectivesModule()
    {
        return m_objectivesModule;
    }
    IGameRulesRoundsModule*							GetRoundsModule()
    {
        return m_roundsModule;
    }
    IGameRulesStatsRecording*						GetStatsRecordingModule()
    {
        return m_statsRecordingModule;
    }
    CMPTrackViewManager*								GetMPTrackViewManager()
    {
        return m_mpTrackViewManager;
    }
    CMPPathFollowingManager*						GetMPPathFollowingManager()
    {
        return m_mpPathFollowingManager;
    }
...
public:
    ...
    {
        return m_bCanUpdateSkillRanking;
    }
    float GetGameStartTime() const
    {
        return m_gameStartedTime.GetMilliSeconds();
    }

    bool LevelNameCheckNeeded() const
    {
        return m_bLevelNameCheckNeeded;
    }
    ...
    {
        return m_hasWinningKill;
    }

    const TCryUserIdSet &GetParticipatingUsers()
    {
        return m_participatingUsers;
    }

#if USE_PC_PREMATCH
    ILINE bool HasGameActuallyStarted() const
    {
        return m_prematchState == ePS_Match;
    }
    ILINE bool IsPrematchCountDown() const
    {
        return m_prematchState == ePS_Countdown;
    }
    ILINE EPrematchState GetPrematchState() const
    {
        return m_prematchState;
    }
#else
    ILINE bool HasGameActuallyStarted() const
    {
