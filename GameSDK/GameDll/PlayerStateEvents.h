...
struct SStateEventLedge : public SStateEvent
{
    ...
    SLedgeTransitionData::EOnLedgeTransition GetLedgeTransition() const
    {
        return static_cast<SLedgeTransitionData::EOnLedgeTransition> (GetData(0).GetInt());
    }
    uint16 GetLedgeId() const
    {
        return (uint16)GetData(1).GetInt();
    }
    bool GetComingFromOnGround() const
    {
        return GetData(2).GetBool();
    }
    bool GetComingFromSprint() const
    {
        return GetData(3).GetBool();
    }
};
...
struct SStateEventSlideKick : public SStateEvent
{
    ...
    {
        return (CMelee*)GetData(1).GetPtr();
    }
};
...
struct SStateEventLadder : public SStateEvent
{
    ...
    IEntity* GetLadder() const
    {
        return (IEntity*)(GetData(0).GetPtr());
    }
};
...
struct SStateEventLeaveLadder : public SStateEvent
{
    ...
    ELadderLeaveLocation GetLeaveLocation() const
    {
        return (ELadderLeaveLocation)(GetData(0).GetInt());
    }
};
...
struct SStateEventPlayerMovementPrePhysics : public SStateEvent
{
    ...
    const SPlayerPrePhysicsData& GetPrePhysicsData() const
    {
        return *static_cast<const SPlayerPrePhysicsData*> (GetData(0).GetPtr());
    }
...
struct SStateEventPlayerInput : public SStateEvent
{
    ...
    const SInputEventData& GetInputEventData() const
    {
        return *static_cast<const SInputEventData*> (GetData(0).GetPtr());
    }
};
...
struct SStateEventCoopAnim : public SStateEvent
{
    ...
    ILINE EntityId GetTargetEntityId() const
    {
...
struct SStateEventJump : public SStateEvent
{
    ...
    ILINE const SPlayerPrePhysicsData& GetPrePhysicsEventData() const
    {
        return *static_cast<const SPlayerPrePhysicsData*> (GetData(eD_PrePhysicsData).GetPtr());
    }
    ILINE float GetVerticalSpeedModifier() const
    {
        return (GetData(eD_VerticalSpeedMofidier).GetFloat());
    }
};
...
struct SStateEventCutScene : public SStateEvent
{
    ...
    ILINE bool IsEnabling() const
    {
        return (GetData(0).GetBool());
    }
};
...
struct SStateEventGroundColliderChanged : public SStateEvent
{
    ...
    ILINE const bool OnGround() const
    {
        return GetData(0).GetBool();
    }
};
...
struct SStateEventButtonMashingSequence : public SStateEvent
{
    ...
    ILINE const Type GetEnemyType() const
    {
        return static_cast<Type>(GetData(0).GetInt());
    }
    ILINE const Params& GetParams() const
    {
        return *static_cast<const Params*>(GetData(1).GetPtr());
    }
    ILINE const CallBacks& GetCallBacks() const
    {
        return *static_cast<const CallBacks*>(GetData(2).GetPtr());
    }
};
