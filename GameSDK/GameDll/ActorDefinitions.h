...
struct SViewLimitParams
{
    ...
    ILINE Vec3 GetViewLimitDir() const
    {
        return vLimitDir;
    }
    ILINE float GetViewLimitRangeH() const
    {
        return vLimitRangeH;
    }
    ILINE float GetViewLimitRangeV() const
    {
        return vLimitRangeV;
    }
    ILINE float GetViewLimitRangeVUp() const
    {
        return vLimitRangeVUp;
    }
    ILINE float GetViewLimitRangeVDown() const
    {
        return vLimitRangeVDown;
    }
    ILINE EViewLimitState GetViewLimitState() const
    {
        return vLimitType;
    }
...
struct SActorStats
{
    ...
    void EnableStatusFlags(TActorStatusFlags reason)
    {
        m_actorStatusFlags |= reason;
    }
    void DisableStatusFlags(TActorStatusFlags reason)
    {
        m_actorStatusFlags &= ~reason;
    }
    bool HasAnyStatusFlags(TActorStatusFlags reasons = ~0) const
    {
        return (m_actorStatusFlags & reasons) != kActorStatus_none;
    }
    bool HasAllStatusFlags(TActorStatusFlags reasons) const
    {
        return (m_actorStatusFlags & reasons) == reasons;
    }
    TActorStatusFlags GetStatusFlags() const
    {
        return m_actorStatusFlags;
    }
