...
private:
    ...
    ILINE void SetInternalPositions ( const Vec3& eye, const Vec3& lookAt )
    {
        m_cameraEye = eye;
...
private:
    ...
    ILINE float GetBlendOrientationFactor() const
    {
        return m_animationSettings.rotationFactor;
    }
    ILINE float GetBlendPositionFactor() const
    {
        return m_animationSettings.positionFactor;
    }
