...
public:
    ...
    void ResetSharedParams(const SFireModeParams* pParams)
    {
        m_fireParams = pParams;
        ResetParams();
    }
    ILINE const SFireModeParams* GetShared() const
    {
        return m_fireParams;
    }
    ILINE const SParentFireModeParams* GetParentShared() const
    {
        return m_parentFireParams;
    }
    ...
    {
        return GetWeapon()->GetMannequinItemParams();
    }
    const SMannequinItemParams::FragmentIDs& GetFragmentIds() const
    {
        return GetWeapon()->GetFragmentIds();
    }
