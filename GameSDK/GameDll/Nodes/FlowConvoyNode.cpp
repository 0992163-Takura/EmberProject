...
void CFlowConvoyNode::DiscoverConvoyCoaches(IEntity *pEntity)
{
	...
	while (pEntity)
	{
		...
		tc.m_frontWheelBase = pSkeletonPose ? pSkeletonPose->GetJointIDByName("wheel_base1") : -1;
		tc.m_backWheelBase = pSkeletonPose ? pSkeletonPose->GetJointIDByName("wheel_base2") : -1;
