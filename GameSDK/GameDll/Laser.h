...
public:
    ...
    Vec3 GetLastHit() const
    {
        return m_lastHit;
    }
    void SetGeometrySlot(eGeometrySlot geometrySlot);
    ILINE void SetParams(SLaserParams* pParams)
    {
        m_pLaserParams = pParams;
    }

    EntityId GetLaserEntityId() const
    {
        return m_laserEntityId;
    }
private:
...
public:
    ...
    bool IsLaserActivated() const
    {
        return m_laserBeam.IsLaserActivated();
    }
