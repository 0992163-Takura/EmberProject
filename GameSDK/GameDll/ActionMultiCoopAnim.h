...
public:
    ...
    struct SParticipant
    {
        ...
        ILINE IAnimatedCharacter& GetAnimatedCharacter ( )
        {
            return m_animChar;
        }
        ILINE IActionController* GetActionController ( )
        {
            return m_pActionController;
        }
        ILINE bool HasFlag ( const EParamFlags flag ) const
        {
            return (m_paramFlags&flag)!=0;
        }
