...
public:
    ...
    EntityId GetDestroyerId() const
    {
        return m_destroyerId;
    };
    ...
    ILINE uint8 GetPathComplete ( ) const
    {
        return m_pathing.pathComplete;
    }
    ILINE void SetPathCompleteNotified ( )
    {
        m_pathing.pathComplete|=0x2;
    }
