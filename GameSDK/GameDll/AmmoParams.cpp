    ...
    if (flagsNode)
        {
            ...
            flagsReader.ReadParamValue<int>("ClientOnly", flag);
            flags |= flag?ENTITY_FLAG_CLIENT_ONLY:0;
            flag=0;
            flagsReader.ReadParamValue<int>("ServerOnly", flag);
    ...
    if (physicalizationType == ePT_Particle)
        {
            ...
            pParticleParams->flags |= flag?particle_constant_orientation:0;
            flag=0;
