...
public:
    ...
    const SZoomModeParams* GetShared() const
    {
        return m_zoomParams;
    }
    const SParentZoomModeParams* GetParentShared()
    {
        return m_parentZoomParams;
    }
    void ResetSharedParams(const SZoomModeParams* pParams)
    {
        m_zoomParams = pParams;
    }
