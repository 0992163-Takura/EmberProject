    ...
    public IWeapon
{
    ...
    public:
        ...
        ILINE bool	IsSet() const
        {
            ...
            return m_pOwnerWeapon->GetFiringLocator() == this;
        }
        void				Release();
...
public:
    ...
    {
        CRY_ASSERT_MESSAGE(0, "DEPRECATED FUNCTIONALITY: use GetMelee() instead");
        return NULL;
    };
    CMelee* GetMelee() const
    {
        return m_melee;
    }
    ...
    {
        return (!IsBusy() && !IsFiring()) || ( gEnv->bMultiplayer && IsReloading() );    //Allowing sprinting while reloading in MP now
    }
    ...
    CScopeReticule& GetScopeReticule()
    {
        return m_scopeReticule;
    }
    const CScopeReticule& GetScopeReticule() const
    {
        return m_scopeReticule;
    }

    const CWeaponStats* GetWeaponStats() const
    {
        return m_pWeaponStats;
    }
    CWeaponStats* GetWeaponStats()
    {
        return m_pWeaponStats;
    }
    ...
    {
        return false;
    }; //Returns true if the weapon is chargeable and currently being charged (after canceling the charge)
    ...
    virtual bool IsRippingOff() const
    {
        return false;
    }
    ...
    ILINE void SetPlaySelectAction( bool bSelect )
    {
        m_shouldPlayWeaponSelectAction = bSelect;
    }
    ...
    const CWeaponSharedParams* GetWeaponSharedParams() const
    {
    ...
    virtual bool IsVehicleWeapon() const
    {
        return false;
    }
    void ShowDebugInfo();
    ...
    ILINE EntityId GetOriginalOwnerId() const
    {
    ...
    bool IsProxyWeapon() const
    {
        return m_isProxyWeapon;
    }
    void SetIsProxyWeapon(bool isProxy)
    {
        m_isProxyWeapon = isProxy;
    }

    virtual bool AllowZoomToggle()
    {
        return true;
    }
    ...
    ILINE bool IsInputFlagSet(uint8 actionFlag) const
    {
        return ((s_requestedActions & actionFlag) != 0);
    }
...
#if defined(ANTI_CHEAT)
    ILINE uint32				GetLastShotId()		const
    {
        return m_lastShotId;
    }
    ILINE static uint32	GetMaxShotCount()
    {
        return 0xFFF;
    }
    ILINE static uint32	GetShotIdCountOffset()
    {
        return 20;
    }
    ILINE static uint32	GetShotIdFireModeOffset()
    {
        return 16;
    }
    ILINE static uint32 GetShotIdFireModeMask()
    {
        return 0x000f0000;
    }
#endif
    ...
    ILINE bool ReloadWhenSelected() const
    {
        return m_bReloadWhenSelected;
    }
...
#ifdef SHOT_DEBUG
    class CShotDebug* GetShotDebug() const
    {
        return m_pShotDebug;
    }
#endif //SHOT_DEBUG
...
protected:
    ...
    ILINE bool IsAnimationControlled() const
    {
        return m_animationFiringLocator.IsSet();
    }
    ...
    {
        s_requestedActions = eWeaponAction_None;
    }
    void SetInputFlag(uint8 actionFlag);
    ILINE void ClearInputFlag(uint8 actionFlag)
    {
