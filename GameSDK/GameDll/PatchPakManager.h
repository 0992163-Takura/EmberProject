...
public:
    ...
    int GetPatchPakVersion()
    {
        return m_patchPakVersion;
    }

    bool HasPatchingSucceeded() const;
    bool AreUpdatedPermissionsAvailable()
    {
        return m_updatedPermissionsAvailable;
    }
    int  TimeThatUpdatedPermissionsBecameAvailable()
    {
        return m_timeThatUpdatedPermissionsAvailable;
    }
    bool IsOkToCachePaks()
    {
        return m_okToCachePaks;    // TODO - use me in the frontend to popup the storage device or warning about having to have storage
    }
