...
typedef struct SAutoaimTarget
{
    ...
    ILINE bool HasFlagSet(EAutoaimTargetFlags _flag) const
    {
        return ((flags & _flag) != 0);
    }
    ILINE bool HasFlagsSet(int8 _flags) const
    {
        return ((flags & _flags) == _flags);
    }
    ILINE void SetFlag(EAutoaimTargetFlags _flag)
    {
        flags |= _flag;
    }
    ILINE void RemoveFlag(EAutoaimTargetFlags _flag)
    {
        flags &= ~_flag;
    }
...
public:
    ...
    ILINE EntityId GetCloseCombatSnapTarget() const
    {
        return m_closeCombatSnapTargetId;
    }
    ILINE float GetCloseCombatSnapTargetRange() const
    {
        return m_closeCombatSnapTargetRange;
    }
    ILINE float GetCloseCombatSnapTargetMoveSpeed() const
    {
        return m_closeCombatSnapTargetMoveSpeed;
    }

    ILINE const TAutoaimTargets& GetAutoAimTargets() const
    {
        return m_autoaimTargets;
    };
