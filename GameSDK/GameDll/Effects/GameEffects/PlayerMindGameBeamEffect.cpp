	...
	Vec3* playerLeftHandPos, Vec3* playerRightHandPos) const
{
	...
	const int16 leftHandJointID = skeletonPose->GetJointIDByName(s_PlayerLeftHandJointName);
	...
	const int16 rightHandJointID = skeletonPose->GetJointIDByName(s_PlayerRightHandJointName);
