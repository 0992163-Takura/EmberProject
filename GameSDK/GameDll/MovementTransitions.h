...
public:
    ...
    {
        return m_pEntityClass;    // only used in CMovementTransitionsSystem
    }
    ...
    ILINE float GetMinDistanceAfterDirectionChange() const
    {
        return m_minDistanceAfterDirectionChange;    // only used in selection params calculation
    }
...
struct STransitionMatch
{
    ...
    ILINE bool IsBetterThan(const STransitionMatch& otherMatch) const
    {
        return angleDifference < otherMatch.angleDifference;
    }
};
