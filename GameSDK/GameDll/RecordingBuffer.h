...
public:
    ...
    public:
        ...
        SRecording_Packet& operator*() const
        {
            return *(SRecording_Packet*)m_pRecordingBuffer->at(m_offset);
        }
        SRecording_Packet* operator->() const
        {
            return (SRecording_Packet*)m_pRecordingBuffer->at(m_offset);
    ...
    {
        return m_actualBufferSize;
    }

    void SetPacketDiscardCallback(PacketDiscardCallback *pdc, void *inUserData)
    {
        m_pDiscardCallback = pdc;
        m_pDiscardCallbackUserData=inUserData;
    }
