            ...
            if (!T::IsWrite() && outputBufferEnd)
                {
                    ...
                    switch (packetType&0x7F)
                        {
                        case eFPP_FPChar:
                            packetSize=sizeof(SRecording_FPChar);
                            break;
                        case eFPP_Flashed:
                            packetSize=sizeof(SRecording_Flashed);
                            break;
                        case eFPP_VictimPosition:
                            packetSize=sizeof(SRecording_VictimPosition);
                            break;
                        case eFPP_KillHitPosition:
                            packetSize=sizeof(SRecording_KillHitPosition);
                            break;
                        case eFPP_BattleChatter:
                            packetSize=sizeof(SRecording_BattleChatter);
                            break;
                        case eFPP_RenderNearest:
                            packetSize=sizeof(SRecording_RenderNearest);
                            break;
                        case eFPP_PlayerHealthEffect:
                            packetSize=sizeof(SRecording_PlayerHealthEffect);
                            break;
                        case eFPP_PlaybackTimeOffset:
                            packetSize=sizeof(SRecording_PlaybackTimeOffset);
                            break;
                        default:
