...
public:
    ...
    {
        return (m_state != eSlideState_None);
    }
    ILINE bool IsSliding() const
    {
        return (m_state == eSlideState_Sliding);
    }
    ILINE bool IsExitingSlide() const
    {
        return (m_state == eSlideState_ExitingSlide);
    }
    ILINE ESlideState GetCurrentState() const
    {
        return m_state;
    }
