...
class CBodyDamageProfile : public _reference_target_t
{
    ...
    struct JointId : std::unary_function<bool, const JointId&>
    {
        ...
        static JointId GetJointIdFromPartId( ISkeletonPose& skeletonPose, const int partId );
    ...
    struct MatMappingId : std::unary_function<bool, const MatMappingId&>
    {
        ...
        static MatMappingId GetMatMappingIdFromPartId( ISkeletonPose& skeletonPose, const int partId );
    ...
    {
    public:
        CEffectiveMaterials(CBodyDamageProfile& bodyDamageProfile, ISkeletonPose& skeletonPose, IPhysicalEntity& physicalEntity);
    ...
    public:
        ...
        const TJointIds& GetJointIds() const
        {
            return m_jointIds;
        }
        ...
        void LoadElements(const XmlNodeRef& partNode, ISkeletonPose& skeletonPose, IAttachmentManager& attachmentManager, CEffectiveMaterials& effectiveMaterials, const CBodyDamageProfile& ownerDamageProfile);
    ...
    public:
        ...
        {
            return 0 == strcmp(m_name, part.GetName().c_str());
        }
    private:
        const char* m_name;
    };
    ...
    public:
        ...
        const TMaterialIds& GetMaterialIds() const
        {
            return m_materialIds;
        }
        const CPart& GetPart() const
        {
            return m_part;
        }
...
public:
    ...
    TBodyDamageProfileId GetId() const
    {
        return m_id;
    }
    ...
    bool PhysicalizeEntity(IPhysicalEntity* pPhysicalEntity, ISkeletonPose* pSkeletonPose) const;
...
private:
    ...
    void LoadImpulseFilters(const XmlNodeRef& rootNode, ISkeletonPose& skeletonPose);
    void LoadImpulseFilter(const XmlNodeRef& filterNode, ISkeletonPose& skeletonPose);
    void LoadImpulse( const XmlNodeRef& filterNode, ISkeletonPose& skeletonPose, const PartId partID );
    void IndexParts();
