...
protected:
    ...
    ILINE int16 GetBulletPierceability() const
    {
        return m_bulletPierceability;
    };
...
private:
    ...
    ILINE float GetDamageAfterPenetrationFallOff() const
    {
        return ((float)m_damage - m_accumulatedDamageFallOffAfterPenetration);
    };
