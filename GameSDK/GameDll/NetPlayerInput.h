...
public:
    ...
    ILINE TSnapType GetSnappedLastUpdate() const
    {
        return m_snapType;
    }
...
public:
    ...
    ILINE TSnapType GetSnappedLastUpdate() const
    {
        return m_lerper.GetSnappedLastUpdate();
    }
    ...
    const Vec3& GetDesiredVelocity(bool& inAir) const
    {
        inAir=m_curInput.inAir;
        return m_desiredVelocity;
    }
    const Vec3 GetRequestedVelocity() const
    {
        return m_curInput.deltaMovement * g_pGameCVars->pl_netSerialiseMaxSpeed;
    }
