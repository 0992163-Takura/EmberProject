                                    ...
                                    if(ISkeletonPose* pPose = pChar->GetISkeletonPose())
                                        {
                                            ...
                                            CRY_ASSERT(pPose->GetJointCount() <= STrackedCorpse::k_maxJoints);
                                            corpse.m_corpseId = pCorpsePacket->corpseId;
                                            corpse.m_numJoints = min((int32) pPose->GetJointCount(), static_cast<int32>(STrackedCorpse::k_maxJoints));
                                            ...
                                            for(TCorpseADIKJointsVec::const_iterator it = m_corpseADIKJointCRCs.begin(); it!=end; ++it)
                                                {
                                                    const int16 jointIdx = pPose->GetJointIDByCRC32(*it);
                                                    if(jointIdx!=-1)
                                                    ...
                                                    if(s_ADIKJoints[i])
                                                        {
                                                            ...
                                                            rel.t.x = 0.f;
                                                            const int32 parent = pPose->GetParentIDByID(i);
                                                            if(parent<0)
                                                                {
                                                                            ...
                                                                            if(ISkeletonPose* pPose = pChar->GetISkeletonPose())
                                                                                {
                                                                                    ...
                                                                                    CRY_ASSERT(pPose->GetJointCount() == numJoints);
