...
public:
    ...
    ILINE void  SetHealth( float fHealth )
    {
        m_health = fHealth;
        m_healthAsRoundedPercentage = int_ceil( m_health * 100.0f / m_healthMax);
    }
    ILINE float GetHealthMax() const
    {
        return m_healthMax;
    }
    ILINE void  SetHealthMax( float fHealthMax )
    {
        m_healthMax = fHealthMax;
    }
    ILINE int   GetHealthAsRoundedPercentage() const
    {
        return m_healthAsRoundedPercentage;
    }
    ILINE bool  IsDead() const
    {
