...
public:
    ...
    const int GetMaxRanks() const
    {
        return k_maxPossibleRanks;
    }
    static const int GetMaxDisplayableRank()
    {
        return k_maxDisplayableRank;
    }
    const int GetMaxReincarnations() const
    {
        return k_maxReincarnation;
    }
    ...
    void AddUINewDisplayFlags(uint32 flags)
    {
        m_uiNewDisplayFlags |= flags;
    }
    void RemoveUINewDisplayFlags(uint32 flags)
    {
        m_uiNewDisplayFlags &= ~flags;
    }
    uint32 CheckUINewDisplayFlags(uint32 flags) const
    {
        return ((m_uiNewDisplayFlags&flags)!=0);
    }
    uint32 GetUINewDisplayFlags() const
    {
        return m_uiNewDisplayFlags;
    }
...
protected:
    ...
    enum { k_maxPossibleRanks=51,
           ...
           k_risingStarRank=20
         }; //Unlock achievement when reaching this rank
