...
public:
    ...
    {
        m_recoilMultiplier = multiplier;
    }
    float GetRecoilmultiplier() const
    {
        return m_recoilMultiplier;
    }
    void SetSpreadMultiplier(float multiplier)
    {
        m_spreadMultiplier = multiplier;
    }
    ...
    ILINE float GetMinSpread() const
    {
        return m_spreadParams.min;
    }
    ILINE float GetMaxSpread() const
    {
        return m_spreadParams.max;
    }
    ILINE float GetBackImpulse() const
    {
        return m_recoilParams.back_impulse;
    }
    ILINE float GetAngularImpulse() const
    {
        return m_recoilParams.angular_impulse;
    }

    ILINE void ApplyMaxSpread(float multiplier = 1.f)
    {
        m_spread = multiplier * m_spreadParams.max;
        m_maxSpreadMultiplier = max(multiplier, 1.f);
    }
