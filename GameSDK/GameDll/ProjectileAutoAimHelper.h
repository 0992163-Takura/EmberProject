...
public:
    ...
    ILINE void SetEnabled(const bool bEnabled)
    {
        m_bEnabled = bEnabled;
    }
    ILINE bool GetEnabled() const
    {
        return m_bEnabled;
    }
...
private:
    ...
    ILINE const ConeParams& GetAimConeSettings(const bool bIsZoomed) const
    {
        return bIsZoomed ? m_pParams->m_zoomedParams : m_pParams->m_normalParams;
    }
