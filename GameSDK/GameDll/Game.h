...
public:
    ...
    void SetInputEventListenerOverride(IInputEventListener *pListenerOverride)
    {
        m_pInputEventListenerOverride = pListenerOverride;
    }
    ...
    {
        return m_bPausedForControllerDisconnect;
    }

#if defined(PS3)
    unsigned int GetActualControllerDeviceIndex() const
    {
        return m_actualControllerDeviceIndex;
    }
#endif
    ...
    CrySessionID GetPendingRichPresenceSessionID()
    {
        return m_pendingRichPresenceSessionID;
    }
    ...
    {
        return m_bSignInOrOutEventOccured;
    }
    ...
    CScriptBind_Weapon *GetWeaponScriptBind()
    {
    ...
    CScriptBind_HUD *GetHUDScriptBind()
    {
        return m_pScriptBindHUD;
    }
    CScriptBind_InteractiveObject* GetInteractiveObjectScriptBind()
    {
        return m_pScriptBindInteractiveObject;
    }
    CScriptBind_MatchMaking* GetMatchMakingScriptBind()
    {
        return m_pScriptBindMatchMaking;
    }
    CScriptBind_Turret* GetTurretScriptBind()
    {
        return m_pScriptBindTurret;
    }
    CScriptBind_TowerSearchLight* GetTowerSearchLightScriptBind()
    {
        return m_pScriptBindTowerSearchLight;
    }
    CScriptBind_LightningArc* GetLightningArcScriptBind()
    {
        return m_pScriptBindLightningArc;
    }
    CWeaponSystem *GetWeaponSystem()
    {
        return m_pWeaponSystem;
    };
    ILINE CGamePhysicsSettings *GetGamePhysicsSettings()
    {
        return m_pGamePhysicsSettings;
    }
    CGameSharedParametersStorage *GetGameSharedParametersStorage()
    {
        return m_pGameParametersStorage;
    };
    CRecordingSystem *GetRecordingSystem()
    {
        return m_pRecordingSystem;
    };
    CStatsRecordingMgr *GetStatsRecorder()
    {
        return m_statsRecorder;
    }
    CPatchPakManager *GetPatchPakManager()
    {
        return m_patchPakManager;
    }
    CMatchmakingTelemetry* GetMatchMakingTelemetry() const
    {
        return m_pMatchMakingTelemetry;
    }
    CDataPatchDownloader *GetDataPatchDownloader()
    {
        return m_pDataPatchDownloader;
    }
    IAntiCheatManager *GetAntiCheatManager()
    {
        return m_pAntiCheatManager;
    }
    ILINE CClientCheatMonitor* GetClientSideCheatMonitor()
    {
        return m_pClientCheatMonitor;
    }
    ILINE CServerCheatMonitor* GetServerSideCheatMonitor()
    {
        return m_pServerCheatMonitor;
    }
    CGameLocalizationManager *GetGameLocalizationManager()
    {
        return m_pGameLocalizationManager;
    }
#if USE_LAGOMETER
    CLagOMeter* GetLagOMeter()
    {
        return m_pLagOMeter;
    }
#endif
    ...
    {
        return m_telemetryCollector;
    }
    CPlaylistActivityTracker*	GetPlaylistActivityTracker()
    {
        return m_pPlaylistActivityTracker;
    }

    ILINE CGameInputActionHandlers& GetGameInputActionHandlers()
    {
        CRY_ASSERT(m_pGameActionHandlers);
        return *m_pGameActionHandlers;
    }

    CLedgeManager*	GetLedgeManager() const
    {
        return m_pLedgeManager;
    };
    CWaterPuddleManager* GetWaterPuddleManager() const
    {
        return m_pWaterPuddleManager;
    }
    ...
    virtual CGameAudio *GetGameAudio() const
    {
        return m_pGameAudio;
    }
    ...
    {
        return m_pPlayerVisTable;
    }
    CPersistantStats *GetPersistantStats() const
    {
        return m_pPersistantStats;
    }

    ILINE CHudInterferenceGameEffect* GetHudInterferenceGameEffect()
    {
        return m_pHudInterferenceGameEffect;
    }
    ILINE CSceneBlurGameEffect* GetSceneBlurGameEffect()
    {
        return m_pSceneBlurGameEffect;
    }
    ILINE CLightningGameEffect* GetLightningGameEffect()
    {
        return m_pLightningGameEffect;
    }
    ILINE CParameterGameEffect* GetParameterGameEffect()
    {
        return m_pParameterGameEffect;
    }
    ILINE CScreenEffects *GetScreenEffects()		const
    {
        return m_pScreenEffects;
    }
    ILINE CAutoAimManager& GetAutoAimManager()	const
    {
        return *m_pAutoAimManager;
    }
    ...
    ILINE CMovementTransitionsSystem& GetMovementTransitionsSystem() const
    {
        CRY_ASSERT(m_pMovementTransitionsSystem);
        return *m_pMovementTransitionsSystem;
    }

    CBodyDamageManager *GetBodyDamageManager()
    {
        return m_pBodyDamageManager;
    }
    ...
    CBurnEffectManager* GetBurnEffectManager() const
    {
        return m_pBurnEffectManager;
    }
    CPlaylistManager* GetPlaylistManager()
    {
        return m_pPlaylistManager;
    }
    ILINE CGameAchievements* GetGameAchievements() const
    {
        return m_pGameAchievements;
    }

    CStatsEntityIdRegistry* GetStatsEntityIdRegistry()
    {
        return m_pStatsEntityIdRegistry;
    }

    ILINE CMovingPlatformMgr* GetMovingPlatformManager()
    {
        return m_pMovingPlatformMgr;
    }
    ...
    CEquipmentLoadout * GetEquipmentLoadout() const
    {
        return m_pEquipmentLoadout;
    }
    CGameAISystem* GetGameAISystem()
    {
        return m_pGameAISystem;
    }
    GlobalRayCaster& GetRayCaster()
    {
        assert(m_pRayCaster);
        return *m_pRayCaster;
    }
    ...
    {
        return m_pDownloadMgr;
    }
    CDLCManager*		GetDLCManager()
    {
        return m_pDLCManager;
    }
    ...
    ILINE CUIManager* GetUI( void )
    {
        return m_pUIManager;
    }
    ILINE CTacticalManager* GetTacticalManager( void ) const
    {
        return m_pTacticalManager;
    }
    CWarningsManager* GetWarnings( void ) const;
    ILINE CModInfoManager* GetModInfoManager() const
    {
        return m_pModInfoManager;
    }
    ...
    {
        return m_currentXboxLivePartySize;
    }
    ...
    {
        return m_gameDataInstalled;
    }
    bool BootChecksComplete() const
    {
        return m_postLocalisationBootChecksDone;
    }
    ...
    {
        return m_iCachedGsmValue;
    }
    float GetCachedGsmRangeValue()
    {
        return m_fCachedGsmRangeValue;
    }
    float GetCachedGsmRangeStepValue()
    {
        return m_fCachedGsmRangeStepValue;
    }
    ...
    void OnEditorDisplayRenderUpdated( bool displayHelpers )
    {
        m_editorDisplayHelpers = displayHelpers;
    }
    bool DisplayEditorHelpersEnabled() const
    {
        return m_editorDisplayHelpers;
    }

    void SetRenderingToHMD( bool bRenderingToHMD )
    {
        m_RenderingToHMD = bRenderingToHMD;
    }
    bool IsRenderingToHMD() const
    {
        return m_RenderingToHMD;
    }
...
public:
    ...
    TStringStringMap *GetVariantOptions()
    {
