...
public:
    ...
    {
        return m_lastRegisteredInputTime;
    }
    ...
    ILINE bool IsAimingWithMouse() const
    {
        return m_isAimingWithMouse;
    }
    ILINE bool IsAimingWithHMD() const
    {
        return m_isAimingWithHMD;
    }
    ILINE bool IsCrouchButtonDown() const
    {
        return m_crouchButtonDown;
    }
    // ~IPlayerInput
    ...
    void ClearProneAction()
    {
        m_actions &= ~ACTION_PRONE;
    }
    void ClearCrouchAction()
    {
        m_actions &= ~ACTION_CROUCH;
    }
    void ClearSprintAction()
    {
    ...
    ILINE bool IsNearLookAtTarget() const
    {
        return m_isNearTheLookAtTarget;
    }
