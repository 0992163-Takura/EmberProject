...
struct FAllowedParts
{
    ...
    {
        int iPartId = m_pCharInstance->GetISkeletonPose()->GetJointIDByName(pName);
                    ...
                    for (int i = 0; i < iCount; ++i)
                        {
                            ...
                            int iPartId = pMainChar->GetISkeletonPose()->GetJointIDByName(szPartName);
