...
public:
    ...
    void ResetScreenFX();
    ILINE bool IsInFreeFallDeath() const
    {
        return m_bIsInFreeFallDeath;
    }

    SMeleeHitParams * GetLastMeleeParams()
    {
        return &m_lastMeleeParams;
    }
    void							SetLastMeleeParams(const SMeleeHitParams& rParams)
    {
        m_lastMeleeParams = rParams;
    }
    ...
    ILINE CPlayer::EClientSoundmoods GetSoundmood()
    {
        return m_soundmood;
    }
    ...
    ILINE const QuatT	&GetLastSTAPCameraDelta() const
    {
        return m_lastSTAPCameraDelta;
    }
    ...
    {
        return m_timeEnteredLowHealth.GetSeconds();
    };
    ...
    void SetHasUsedAutoArmour()
    {
        m_autoArmourFlags |= EAAF_UsedAutoArmour;
    }
    void SetHasTakenDamageWithArmour()
    {
        m_autoArmourFlags |= EAAF_TakenDamageWithArmor;
    }
    void SetHasEnteredSpectatorMode()
    {
        m_autoArmourFlags |= EAAF_EnteredSpectatorMode;
    }
    bool CanCompleteTrainingWheelsAchievement() const
    {
        return m_autoArmourFlags == EAAF_TakenDamageWithArmor;
    }

    ILINE CPlayerEntityInteraction& GetPlayerEntityInteraction()
    {
        return m_playerEntityInteraction;
    }
