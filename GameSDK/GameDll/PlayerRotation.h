...
public:
    ...
    ILINE				 void SetBaseQuat(const Quat &baseQuat)
    {
        m_baseQuat = baseQuat;
    }

    ILINE const Quat& GetBaseQuat() const
    {
        return m_baseQuat;
    }
    ILINE const Quat& GetViewQuat() const
    {
        return m_viewQuat;
    }
    ILINE const Quat& GetViewQuatFinal() const
    {
        return m_viewQuatFinal;
    }
    ILINE const Ang3& GetViewAngles() const
    {
        return m_viewAngles;
    }
    ILINE       float GetLeanAmount() const
    {
        return m_leanAmount;
    }
    ILINE       float GetLeanPeekOverAmount() const
    {
        return m_peekOverAmount;
    }
