...
{
    SAccessoryMeleeParams() : pAlteredMeleeParams(NULL)
    {
        pAccessories[0] = pAccessories[1] = pAccessories[2] = pAccessories[3] = NULL;
    }
...
{
    SAccessoryFireModeParams() : pAlteredParams(NULL)
    {
        pAccessories[0] = pAccessories[1] = pAccessories[2] = pAccessories[3] = NULL;
    }
