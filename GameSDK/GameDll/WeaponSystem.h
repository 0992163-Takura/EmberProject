...
public:
    ...
    const TLinkedProjectileMap& GetLinkedProjectiles()
    {
        return m_linkedProjectiles;
    }
    ...
    const CWeaponAlias &GetWeaponAlias()
    {
        return m_weaponAlias;
    };
    CDelayedDetonationRMIQueue& GetProjectileDelayedDetonationRMIQueue()
    {
        return m_detonationRMIQueue;
    }
