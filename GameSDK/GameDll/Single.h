...
public:
    ...
    {
        return m_recoil.GetRecoil();
    }
    virtual float GetSpread() const
    {
        return m_recoil.GetSpread();
    }
    ...
    {
        return m_recoil.GetMinSpread();
    }
    float GetMaxSpread() const
    {
        return m_recoil.GetMaxSpread();
    }
...
protected:
    ...
    bool IsProceduralRecoilEnabled() const
    {
        return m_fireParams->proceduralRecoilParams.enabled;
    }
