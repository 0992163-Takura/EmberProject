...
public:
    ...
    CAfterMatchAwards *GetAfterMatchAwards()
    {
        return &m_afterMatchAwards;
    }
    ...
    ILINE bool IsInGame() const
    {
        return m_inGame;
    }
    ILINE void SetInGame(const bool inGame)
    {
        m_inGame = inGame;
    }
    ...
    const char* GetFavoriteWeaponStr() const
    {
        return m_favoriteWeapon;
    }
    const char* GetFavoriteAttachmentStr() const
    {
        return m_favoriteAttachment;
    }
