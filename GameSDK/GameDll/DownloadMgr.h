...
public:
    ...
    {
        return (m_broadcastedState!=k_notBroadcasted);
    }

    // returns download description
    const char*									GetDescription()
    {
        return m_descName.c_str();
    }
    ...
    {
        return m_pService ? m_pService->GetURLPrefix() : "";
    }

    // returns download Server
    const char*									GetServer()
    {
        return m_pService ? m_pService->GetServerName() : "";
    }

    // returns download Port
    int													GetPort()
    {
        return m_pService ? m_pService->GetPort() : 0;
    }

    // returns download Max Size
    int													GetMaxSize()
    {
        return m_maxDownloadSize;
    }
