...
public:
    ...
    ILINE bool IsValidBodyDamageProfileID(const TBodyDamageProfileId bodyDamageProfileID) const
    {
        return (bodyDamageProfileID < m_bodyDamageProfiles.size());    // Note: INVALID_BODYDAMAGEPROFILEID will most certainly be > m_bodyDamageProfiles.size().
    }
