...
public:
    ...
    {
        return m_state == eState_Done;
    }
    ILINE bool IsInInteractiveAction() const
    {
        return (m_state != eState_None) && !HasFinished();
    }
    ...
    EntityId GetInteractiveObjectId() const
    {
        return m_interactiveObjectId;
    }
